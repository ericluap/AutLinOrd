...
\chapter{McCleary}
Here we develop some of the theory from ``The structure of
intransitive ordered permutation groups'' by Stephen H. McCleary.

For any linear order $S$, we have that the collection of automorphims
$A(S)$ is an $l$-group under their pointwise ordering.